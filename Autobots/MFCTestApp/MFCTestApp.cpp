...
// MFCTestApp.cpp : Defines the class behaviors for the application.
//
...
// The one and only CMFCTestAppApp object

CMFCTestAppApp theApp;


// CMFCTestAppApp initialization
